...
final class GitHubReleaseClientTests: XCTestCase {
    func testFetchReleasesDecodesGitHubFieldsAndAssetURLs() async throws {
        ...
        XCTAssertEqual(
            ...
            "https://github.com/yanbohon/UsageMonitor/releases/download/v1.2.3-beta.1/UsageMonitor.dmg"
        )
        XCTAssertEqual(
            releases[0].checksumAsset?.browserDownloadURL.absoluteString,
            "https://github.com/yanbohon/UsageMonitor/releases/download/v1.2.3-beta.1/UsageMonitor.dmg.sha256"
        )
        XCTAssertEqual(loader.requests.count, 1)
        XCTAssertEqual(loader.requests[0].url?.absoluteString, "https://api.github.com/repos/yanbohon/UsageMonitor/releases")
    }
    ...
    [
      {
        ...
        "html_url": "https://github.com/yanbohon/UsageMonitor/releases/tag/v1.2.3-beta.1",
        "assets": [
          {
            "name": "UsageMonitor.dmg",
            "browser_download_url": "https://github.com/yanbohon/UsageMonitor/releases/download/v1.2.3-beta.1/UsageMonitor.dmg"
          },
          {
            "name": "UsageMonitor.dmg.sha256",
            "browser_download_url": "https://github.com/yanbohon/UsageMonitor/releases/download/v1.2.3-beta.1/UsageMonitor.dmg.sha256"
          }
        ]
      }
    ]
